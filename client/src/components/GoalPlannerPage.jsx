  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3 pb-2 border-b border-white/10">
        <div className="inline-flex items-center justify-center gap-2 px-3.5 py-1 rounded-full bg-pink-500/10 text-pink-400 text-xs font-bold border border-pink-500/20">
