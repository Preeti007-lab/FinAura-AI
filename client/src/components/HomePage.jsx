...
import { Sparkles, Layers, BookOpen, BrainCircuit, ArrowRight, CheckCircle2, ShieldCheck, Lock, RotateCw } from 'lucide-react';
import FlashCardItem from './FlashCardItem';

export default function HomePage({ setActiveTab, onOpenAuthModal }) {
  const sampleCard = {
    _id: 'demo_sample',
    ...
    <div className="space-y-20 pb-20 pt-6 max-w-7xl mx-auto px-4">
      ...
      <section className="text-center max-w-4xl mx-auto space-y-6 pt-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            ...
            className="btn-primary text-base py-3.5 px-8 rounded-2xl w-full sm:w-auto justify-center"
          >
          ...
          <button
            ...
            className="btn-glass text-base py-3.5 px-8 rounded-2xl w-full sm:w-auto justify-center"
          >
            Log In to FlashGen
          </button>
        </div>
      ...
      <section className="space-y-8">
        ...
        <div className="text-center max-w-xl mx-auto space-y-2">
          <h2 className="text-3xl font-extrabold text-white font-['Outfit']">Designed for Maximum Retention</h2>
          <p className="text-xs text-slate-400">Everything you need to master complex subjects effortlessy.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div>
              ...
              <span className="badge badge-blue mb-2">Groq AI Engine</span>
              <h3 className="text-xl font-bold text-white mb-2 font-['Outfit']">Instant Flashcard Generation</h3>
              <p className="text-xs text-slate-400 leading-relaxed mb-6">
                Enter any topic name (Quantum Physics, Organic Chemistry, Finance, Code) and select card count (1-6). Groq AI builds key questions & explanations.
              </p>
            </div>
            <div className="text-xs font-extrabold text-indigo-400 flex items-center justify-center gap-1">
              Generate Cards <ArrowRight className="w-4 h-4" />
            </div>
          </div>
          ...
          >
            <div>
              ...
              <span className="badge badge-green mb-2">Persistent Vault</span>
              <h3 className="text-xl font-bold text-white mb-2 font-['Outfit']">Stored Flashcard Collection</h3>
              <p className="text-xs text-slate-400 leading-relaxed mb-6">
          ...
          <div 
            onClick={() => onOpenAuthModal('login')}
            className="flashcard flashcard-interactive p-8 text-center border-pink-500/30 flex flex-col justify-between"
          >
            <div>
